        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('MESSAGES_PAGE_menu_ICN_ON_TAP');
                ...
                Expanded(
                  child: StreamBuilder<List<ChatsRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<ChatsRecord> userChatListChatsRecordList =
                          snapshot.data!;
                      if (userChatListChatsRecordList.isEmpty) {
                        return const EmptyMessagesWidget();
                      }
                      return ListView.builder(
                        padding: EdgeInsets.zero,
                        scrollDirection: Axis.vertical,
                        itemCount: userChatListChatsRecordList.length,
                        itemBuilder: (context, userChatListIndex) {
                          final userChatListChatsRecord =
                              userChatListChatsRecordList[userChatListIndex];
                          return InkWell(
                              ...
                              child: Padding(
                                ...
                                child: StreamBuilder<BusinessesRecord>(
                                  stream: BusinessesRecord.getDocument(
                                      userChatListChatsRecord.business!),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                      return Center(
                                    ...
                                    final rowBusinessesRecord = snapshot.data!;
                                    return Row(
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                                        if (userChatListChatsRecord.business !=
                                            null)
                                          Container(
                                            width: 40.0,
                                            height: 40.0,
                                            ...
                                            child: Image.network(
                                              rowBusinessesRecord.vendorLogo,
                                              fit: BoxFit.fitWidth,
                                            ),
                                          ),
                                        Expanded(
