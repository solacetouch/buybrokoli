...
import 'claim_businesses_model.dart';
export 'claim_businesses_model.dart';

class ClaimBusinessesWidget extends StatefulWidget {
  const ClaimBusinessesWidget({
    super.key,
    this.business,
    this.pageLink,
    required this.state,
  ...
  @override
  State<ClaimBusinessesWidget> createState() => _ClaimBusinessesWidgetState();
}

class _ClaimBusinessesWidgetState extends State<ClaimBusinessesWidget> {
  late ClaimBusinessesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClaimBusinessesModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ClaimBusinesses'});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<BusinessesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final claimBusinessesBusinessesRecord = snapshot.data!;
        return Title(
            title: 'ClaimBusinesses',
              ...
              child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  leading: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'CLAIM_BUSINESSES_arrow_back_rounded_ICN_');
                      logFirebaseEvent('IconButton_navigate_back');
                      context.pop();
                    },
                  ),
                  title: Text(
                    'Claim ${claimBusinessesBusinessesRecord.vendorName}',
                          ...
                          children: [
                            Flexible(
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 24.0, 0.0, 24.0),
                                child: StreamBuilder<List<LegalizationRecord>>(
                                  stream: queryLegalizationRecord(
                                    queryBuilder: (legalizationRecord) =>
                                        legalizationRecord.where(
                                      'State',
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<LegalizationRecord>
                                        containerLegalizationRecordList =
                                        snapshot.data!;
                                    // Return an empty Container when the item does not exist.
                                    if (snapshot.data!.isEmpty) {
                                      return Container();
                                    }
                                    final containerLegalizationRecord =
                                        containerLegalizationRecordList
                                                .isNotEmpty
                                            ? containerLegalizationRecordList
                                                .first
                                            ...
                                            children: [
                                                    ...
                                                    Expanded(
                                                      child: Padding(
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'CLAIM_BUSINESSES_EXPIRATION_DATE_BTN_ON_');
                                                            logFirebaseEvent(
                                              ...
                                              Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'CLAIM_BUSINESSES_PAGE_SUBMIT_BTN_ON_TAP');
                                                    logFirebaseEvent(
                                                    ...
                                                    _model.apiResult5v8 =
                                                      ...
                                                      tag: 'claimVendorProfile',
                                                      documentID:
                                                          currentUserReference
                                                              ?.id,
                                                    );
                                                    if ((_model.apiResult5v8
                                                            ?.succeeded ??
                                                        true)) {
                                                      logFirebaseEvent(
                                                          'Button_alert_dialog');
