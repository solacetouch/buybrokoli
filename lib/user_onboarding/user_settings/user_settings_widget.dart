          ...
          if (loggedIn)
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  logFirebaseEvent('USER_SETTINGS_COMP_Row_qa8g85v5_ON_TAP');
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'USER_SETTINGS_COMP_Text_jwlf4do7_ON_TAP');
          ...
          if (!loggedIn)
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  logFirebaseEvent('USER_SETTINGS_COMP_Row_r8hldw0d_ON_TAP');
                  logFirebaseEvent('Row_navigate_to');
                  ...
                  children: [
                    AuthUserStreamWidget(
                      builder: (context) => ClipRRect(
                        borderRadius: BorderRadius.circular(50.0),
                        child: Image.asset(
                          'assets/images/BuyBrokoli_logo_icon.png',
                          width: 44.0,
                          height: 44.0,
                          fit: BoxFit.cover,
                        ),
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'USER_SETTINGS_COMP_Text_usqkuvto_ON_TAP');
                          logFirebaseEvent('Text_navigate_to');

                          context.pushNamed(
                            'Login',
                            queryParameters: {
                              'lastPage': serializeParam(
                                '',
                                ParamType.String,
                              ),
                            }.withoutNulls,
