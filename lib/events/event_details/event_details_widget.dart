                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: Image.network(
                                              containerEventsRecord.eventPic,
                                              width: double.infinity,
                                              height: 230.0,
                                              fit: BoxFit.cover,
                                            ),
                                          ...
                                          children: [
                                            ...
                                            Builder(
                                              builder: (context) =>
                                                ...
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'EVENT_DETAILS_PAGE_ios_share_ICN_ON_TAP');
                                                  logFirebaseEvent(
                                                  ...
                                                  _model.currentPageLink =
                                                    ...
                                                    context,
                                                    title:
                                                        '${containerEventsRecord.eventName} | BuyBrokoli App',
                                                    imageUrl:
                                                        containerEventsRecord
                                                            .eventPic,
                                                    description:
                                                        'Check out this event on BuyBrokoli!',
                                                    forceRedirect: true,
                                                  );
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'EVENT_DETAILS_REGISTER_NOW_BTN_ON_TAP');
                                logFirebaseEvent('Button_launch_u_r_l');
                                await launchURL(containerEventsRecord.link);
                              },
                              text: 'Register Now',
