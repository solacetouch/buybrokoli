          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('NEWS_PAGE_menu_ICN_ON_TAP');
              ...
              actions: [
                Visibility(
                  ...
                  child: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('NEWS_PAGE_solidUserCircle_ICN_ON_TAP');
                                  ...
                                  child: Padding(
                                    ...
                                    child: StreamBuilder<List<NewsRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<NewsRecord> card7NewsRecordList =
                                            snapshot.data!;
                                        final card7NewsRecord =
                                            card7NewsRecordList.isNotEmpty
                                                ? card7NewsRecordList.first
                                                : null;
                                        return InkWell(
